...
import type { Company, Contact, Deal, DealStages } from '@/types/crm';
...
export default function DealEdit({ deal, contacts, companies, stages }: Props) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        company_id: deal?.company?.id?.toString() ?? '',
        notes: deal?.notes ?? '',
    });
    ...
    return (
        <AppLayout
            breadcrumbs={[
                ...
                { title: 'Edit', href: `/crm/deals/${deal.id}/edit` },
            ]}
        >
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="grid gap-4 md:grid-cols-2">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Select value={data.stage} onValueChange={(value) => setData('stage', value as Deal['stage'])}>
                                        <SelectTrigger>
                                            <SelectValue />
                                        </SelectTrigger>
                                        <SelectContent>
